...
import 'package:gestion_certificat/page/user/appbar.dart';
import 'package:gestion_certificat/page/user/custom_card.dart';
import 'package:gestion_certificat/page/user/demande_certificat.dart';
...
class _AcceuilHabitantState extends State<AcceuilHabitant> {
  ...
  Widget build(BuildContext context) {
    return Material(
      child: Scaffold(
        appBar: MyAppbar1(nomUtilisateur: "Baye Mor Diouf", profilUtilisateur: "Habitant",),
        body: Column(
          children: [
