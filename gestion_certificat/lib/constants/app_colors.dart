...
class AppColors {
  ...
  static const Color primary = Color.fromARGB(255, 41, 130, 103);   // Vert foncé que tu avais demandé
  static const Color secondary = Color.fromARGB(255, 255, 255, 255); // Vert moyen (optionnel)
  ...
  static const Color miniBackground = Color(0xFFE7F4E8); 

  // Couleurs de carte
  static const Color cardBackground1 = Color.fromARGB(255, 41, 130, 103); // Blanc
  static const Color cardBackground2 = Color(0xFF3AC0A0); // Blanc


  // Couleurs de texte
  static const Color textPrimary = Color.fromARGB(255, 41, 130, 103);
  static const Color textSecondary =Color.fromARGB(140 , 41, 130, 103);
