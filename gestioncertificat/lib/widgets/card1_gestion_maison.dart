...
class Card1GestionMaison extends StatelessWidget {
  final String numMaison;
  ...
  const Card1GestionMaison({
    super.key,
    required this.numMaison,
            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset('assets/images/maison.png', height: 70),
                ),
              ),
